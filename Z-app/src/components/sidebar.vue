<template>
      <div class="h-screen border-r-2 border-red-800 bg-stone-900" id="side-bar" :class="dataOpenSideBar == true ? 'side-bar-visible' : 'side-bar-close'">
        <div class="bg-stone-900 border-b border-red-800 h-[50px] flex justify-center items-center ">
          ...
          <img src="https://avatars.githubusercontent.com/u/97021587?v=4" v-show="!dataOpenSideBar" class="p-1 w-8 h-8 rounded-full ring-2 ring-red-800 " alt="Avatar" />
        </div>
        <div class="flex flex-col justify-between h-[calc(100vh-3rem)] bg-stone-900">
          <div class="menu-man text-left px-2 whitespace-nowrap ">
            ...
            <div class="   py-3 rounded-md cursor-pointer  text-gray-300 hover:text-white">
              <router-link to="/admin/product" class="px-2 flex space-x-2"><span class="pi pi-cart-plus " v-tooltip.right="'Product'"></span> <span v-show="dataOpenSideBar">Product</span></router-link>
            </div>
            <div class="  py-3 rounded-md cursor-pointer text-gray-300 hover:text-white">
